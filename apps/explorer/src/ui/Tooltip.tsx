...
export function Tooltip({ tip, children, placement = 'top', isInline = false }: TooltipProps) {
	...
	return (
		<>
			{isInline ? (
				<div tabIndex={0} className="inline-block w-fit" {...getReferenceProps({ ref: reference })}>
					{children}
				</div>
			) : (
